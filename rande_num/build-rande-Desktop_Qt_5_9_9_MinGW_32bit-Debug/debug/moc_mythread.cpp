...
QT_MOC_LITERAL(4, 31, 3) // "num"
    ...
    "Insertion\0finish\0\0QVector<int>\0num"
};
#undef QT_MOC_LITERAL
...
void Insertion::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (Insertion::*_t)(QVector<int> );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Insertion::finish)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Insertion::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_Insertion.data,
...
// SIGNAL 0
void Insertion::finish(QVector<int> _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
    QMetaObject::activate(this, &staticMetaObject, 0, _a);
}
